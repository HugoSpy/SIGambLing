...
const BADGE_DEFINITIONS: BadgeDefinition[] = [
  {
    ...
    description: "Premiere recompense quotidienne confirmee.",
    lockedDescription: "Recuperez votre premiere recompense du jour.",
    tone: "cyan",
    rarity: "common",
    icon: "gift",
    getProgress: ({ user }) => ({
  ...
  },
  {
    key: "streak_3",
    name: "Serie en route",
    description: "Serie de 3 jours validee.",
    lockedDescription: "Tenez 3 jours d'affilee pour deverrouiller ce badge.",
    tone: "orange",
    rarity: "common",
    icon: "flame",
    getProgress: ({ user }) => ({
  ...
  },
  {
    key: "sharp_bettor",
    name: "Paris en serie",
    description: "5 paris d'evenements gagnes.",
    lockedDescription: "Accumulez 5 victoires sur les marches.",
    tone: "emerald",
    rarity: "rare",
    icon: "target",
    getProgress: ({ stats }) => ({
  ...
  },
  {
    key: "table_hot",
    name: "Table chaude",
    description: "5 victoires en casino confirmees.",
  ...
  },
  {
    ...
    lockedDescription: "Montez votre bankroll jusqu'a 5 000 tokens.",
    tone: "amber",
    rarity: "epic",
    icon: "coins",
    getProgress: ({ user }) => ({
  ...
  },
  {
    ...
    description: "Premier marche ou premiere proposition publiee.",
    lockedDescription: "Creez ou proposez un marche pour rejoindre la liste.",
    tone: "sky",
    rarity: "common",
    icon: "layout-grid",
    getProgress: ({ stats }) => ({
